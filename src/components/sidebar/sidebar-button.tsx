...
export const SidebarButton = ({text, onClick, selected = false, className}: SidebarButtonProps) => {
  return (
    <Button className={cn("text-white border-transparent bg-transparent gap-4 hover:scale-105", className)} onClick={onClick}>
      <TextLine text={text} type="text" color={selected ? "red" : "white"} />
